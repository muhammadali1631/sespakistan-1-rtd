...
const projects: ProjectShowcaseProps[] = [
  ...
  {
    id: 4,
    mainImage: { src: "/project/project-4/main.jpeg", alt: "Project 4" },
    title: "Pakistan Army",
    images: [
  ...
  {
    id: 8,
    mainImage: { src: "/project/project-10/image-1.jpeg", alt: "Project 10" },
    title: "Visual Soft Pakistan Private Limited.",
    images: [
      { src: "/project/project-10/image-2.jpeg", alt: "Project 10" },
      { src: "/project/project-10/image-3.jpeg", alt: "Project 10" },
      { src: "/project/project-10/image-4.jpeg", alt: "Project 10" },
      { src: "/project/project-10/image-5.jpeg", alt: "Project 10" },
      { src: "/project/project-10/image-6.jpeg", alt: "Project 10" },
    ],
    content: [
  "Scope of Work: Complete office design, renovation, and fit-out works for Visual Soft Pakistan (Pvt.) Ltd.",
  "Workspace Planning: Complete space planning and interior design, including office workstations, meeting/conference rooms, reception and waiting areas, and pantry/breakout spaces.",
  "MEP & Technical Systems: Integrated MEP works, electrical and lighting systems, HVAC/AC installation, and complete data and networking infrastructure.",
  "Interior Aesthetics: Interior finishing works including glass partitions and doors, gypsum ceilings and drywall, flooring and carpeting, office furniture, and modern workspace elements.",
  "Project Execution: Complete project execution and supervision covering design, procurement, renovation, MEP services, interior finishing, and final office fit-out.",
],
  },
  {
    id: 9,
